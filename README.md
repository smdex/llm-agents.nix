...
<details>
<summary><strong>happier</strong> - End-to-end encrypted cross-device companion for coding agents</summary>
...
<details>
<summary><strong>happier-server</strong> - Self-hosted, end-to-end encrypted Happier sync server</summary>

- **Source**: binary
- **License**: MIT
- **Homepage**: https://github.com/happier-dev/happier
- **Usage**: `nix run github:numtide/llm-agents.nix#happier-server -- --help`
- **Nix**: [packages/happier-server/package.nix](packages/happier-server/package.nix)
